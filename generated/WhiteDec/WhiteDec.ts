...
export class WhiteDec__papersResult {
  value0: BigInt;
  value1: Address;
  value2: string;
  value3: string;
...
export class WhiteDec extends ethereum.SmartContract {
  static bind(address: Address): WhiteDec {
    return new WhiteDec("WhiteDec", address);
  }
  ...
  papers(param0: BigInt): WhiteDec__papersResult {
    let result = super.call(
      "papers",
    ...
    return new WhiteDec__papersResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toString(),
      result[3].toString(),
  ...
  try_papers(param0: BigInt): ethereum.CallResult<WhiteDec__papersResult> {
    let result = super.tryCall(
      "papers",
      "papers(uint256):(uint256,address,string,string,bool,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
